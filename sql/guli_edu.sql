...
-- ----------------------------
-- Table structure for edu_chapter_part
-- ----------------------------
DROP TABLE IF EXISTS `edu_chapter_part`;
CREATE TABLE `edu_chapter_part`  (
  ...
  `note_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '笔记链接',
